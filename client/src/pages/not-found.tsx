  ...
  return (
    <PageWrapper>
      ...
      <div className="min-h-screen w-full flex flex-col bg-background text-foreground font-sans antialiased">
        <Navbar />
        <main id="main-content" className="flex-1 flex items-center justify-center px-4 pt-safe-centered pb-16">
          <div className="w-full max-w-md flex flex-col items-center text-center">
            <Logo href="/" variant={theme === "light" ? "light" : "dark"} className="mb-8" />
            <div className="w-full rounded-2xl border border-border bg-card p-8 sm:p-10 shadow-xl">
              ...
              <h1 className="text-2xl sm:text-3xl font-semibold text-foreground tracking-tight mb-2">Oops! Page not found</h1>
