...
export default function TermsOfService() {
  ...
  return (
    <PageWrapper>
      <SEOHead title="Terms of Service" path="/terms-of-service" />
        ...
        <section id="main-content" className="pt-safe-lg pb-16 sm:pb-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mt-3 mb-4" data-testid="text-terms-title">
                {t("terms.title")}
              </h1>
              <p className="text-slate-400 max-w-2xl mx-auto text-base sm:text-lg" data-testid="text-terms-subtitle">
                {t("terms.subtitle")}
              </p>
              <p className="text-slate-500 text-sm mt-4">{t("terms.lastUpdated")}</p>
            </motion.div>
            ...
            >
              <div className="flex items-start gap-4">
                <div className="shrink-0 w-10 h-10 rounded-md bg-neon-purple/10 flex items-center justify-center mt-1">
