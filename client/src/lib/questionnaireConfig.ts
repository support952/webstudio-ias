...
export const QUESTIONNAIRE_BY_SERVICE: Record<ServiceType, QuestionDef[]> = {
  websites: [
    { id: "site_type", type: "select", labelKey: "questionnaire.websites.site_type", options: [
    ...
    { id: "business_name", type: "text", labelKey: "questionnaire.planning.business_name", placeholderKey: "questionnaire.planning.business_name_placeholder" },
    { id: "describe_business", type: "textarea", labelKey: "questionnaire.planning.describe_business", placeholderKey: "questionnaire.planning.describe_business_placeholder" },
    { id: "products_services", type: "textarea", labelKey: "questionnaire.planning.products_services", placeholderKey: "questionnaire.planning.products_services_placeholder" },
    ...
    { id: "main_purpose", type: "textarea", labelKey: "questionnaire.planning.main_purpose", placeholderKey: "questionnaire.planning.main_purpose_placeholder" },
    { id: "desired_actions", type: "textarea", labelKey: "questionnaire.planning.desired_actions", placeholderKey: "questionnaire.planning.desired_actions_placeholder" },
    { id: "target_audience_desc", type: "textarea", labelKey: "questionnaire.planning.target_audience_desc", placeholderKey: "questionnaire.planning.target_audience_desc_placeholder" },
    { id: "b2b_b2c", type: "select", labelKey: "questionnaire.planning.b2b_b2c", options: [
    ...
    { id: "required_pages", type: "textarea", labelKey: "questionnaire.planning.required_pages", placeholderKey: "questionnaire.planning.required_pages_placeholder" },
    { id: "has_logo_brand", type: "radio", labelKey: "questionnaire.planning.logo_brand_guidelines", options: [
      { value: "yes", labelKey: "questionnaire.options.yes" },
      { value: "no", labelKey: "questionnaire.options.no" },
    ]},
    { id: "preferred_style", type: "select", labelKey: "questionnaire.planning.preferred_style", options: [
  ...
  digital_business_card: [
    { id: "full_name", type: "text", labelKey: "questionnaire.card.full_name", placeholderKey: "questionnaire.card.full_name_placeholder" },
    { id: "role_title", type: "text", labelKey: "questionnaire.card.role_title", placeholderKey: "questionnaire.card.role_title_placeholder" },
    { id: "company_name", type: "text", labelKey: "questionnaire.card.company_name", placeholderKey: "questionnaire.card.company_name_placeholder" },
    { id: "industry", type: "text", labelKey: "questionnaire.card.industry", placeholderKey: "questionnaire.card.industry_placeholder" },
    ...
    { id: "contact_email", type: "text", labelKey: "questionnaire.card.contact_email", placeholderKey: "questionnaire.card.contact_email_placeholder" },
    { id: "whatsapp", type: "text", labelKey: "questionnaire.card.whatsapp", placeholderKey: "questionnaire.card.whatsapp_placeholder" },
    { id: "has_logo", type: "radio", labelKey: "questionnaire.card.has_logo", options: [
      { value: "yes", labelKey: "questionnaire.options.yes" },
      { value: "no", labelKey: "questionnaire.options.no" },
    ]},
    { id: "preferred_style", type: "select", labelKey: "questionnaire.planning.preferred_style", options: [
  ...
  marketing_ppc: [
    ...
    { id: "has_website", type: "radio", labelKey: "questionnaire.ppc.has_website", options: [
      { value: "yes", labelKey: "questionnaire.options.yes" },
      { value: "no", labelKey: "questionnaire.options.no" },
    ]},
    { id: "landing_url", type: "text", labelKey: "questionnaire.ppc.landing_url", placeholderKey: "questionnaire.ppc.landing_url_placeholder" },
    { id: "keywords_topics", type: "textarea", labelKey: "questionnaire.ppc.keywords_topics", placeholderKey: "questionnaire.ppc.keywords_topics_placeholder" },
    { id: "phone", type: "text", labelKey: "questionnaire.phone", placeholderKey: "questionnaire.phone_placeholder", required: true },
    { id: "phone_2", type: "text", labelKey: "questionnaire.phone_2", placeholderKey: "questionnaire.phone_2_placeholder" },
    { id: "business_hours", type: "text", labelKey: "questionnaire.business_hours", placeholderKey: "questionnaire.business_hours_placeholder" },
    { id: "timeline", type: "select", labelKey: "questionnaire.timeline", options: [
